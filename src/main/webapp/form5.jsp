<%-- 
    Document   : form5
    Created on : 15-Aug-2022, 4:04:33 PM
        ...
        <%! void connectDB()
    {
     ...
     <%
        ...
        try
        {
            ...
            stmt.executeUpdate("delete from student1 where roll='"+session.getAttribute("r1")+"' and book_name='"+session.getAttribute("b1")+"'");
            ...
            if(pq.next())
            {
                ...
                stmt.executeUpdate("Update book set noca = '"+av+"' where book_name='"+session.getAttribute("b1")+"'");
