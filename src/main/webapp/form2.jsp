<%-- 
    Document   : form2
    Created on : 12-Aug-2022, 10:59:57 PM
        ...
        <%! void connectDB()
    {
     ...
     %>   
        ...
        <% 
          ...
          ResultSet rs = stmt.executeQuery("Select* From login1 where email = '"+request.getParameter("email")+"' ");
        ...
        JOptionPane.showMessageDialog(null,"User Already Exist");
         ...
         {
         stmt.executeUpdate("insert into login1 values('"+str+"','"+str1+"' ,'"+str2+"','"+str3+"','"+str4+"','"+str5+"')");
