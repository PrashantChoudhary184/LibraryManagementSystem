<%-- 
    Document   : return1
    Created on : 22-Aug-2022, 1:48:29 PM
    ...
    <%! void connectDB()
    {
     ...
     <%  
            ...
            try
        {
            ...
            ResultSet pq = stmt.executeQuery("select * from student1 where roll = '"+request.getParameter("roll")+"'");
        ...
        <br>
              ...
              ResultSet ab = stmt.executeQuery("select * from student1 where roll ='"+request.getParameter("roll")+"' ");       
        ...
        <button type="submit">Submit</button>
             ...
             <%
                  ResultSet jk = stmt.executeQuery("select * from student1 where roll ='"+request.getParameter("roll")+"' and book_name='"+request.getParameter("books")+"'");
                  if(jk.next()){     
             %>
            ...
            ResultSet xy = stmt.executeQuery("select * from student1 where roll = '"+request.getParameter("roll")+"'");
